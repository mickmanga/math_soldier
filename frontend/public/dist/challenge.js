...
(See https://redux.js.org/faq/organizing-state#can-i-put-functions-promises-or-other-non-serializable-items-in-my-store-state)`);
  ...
  var ANIMATION_ID = /* @__PURE__ */ ((ANIMATION_ID2) => {
    ...
    ANIMATION_ID2[ANIMATION_ID2["pnj2_idle"] = 49] = "pnj2_idle";
    ANIMATION_ID2[ANIMATION_ID2["king_opponent_idle"] = 50] = "king_opponent_idle";
    ANIMATION_ID2[ANIMATION_ID2["king_opponent_run"] = 51] = "king_opponent_run";
    ANIMATION_ID2[ANIMATION_ID2["king_opponent_attack"] = 52] = "king_opponent_attack";
    ANIMATION_ID2[ANIMATION_ID2["king_opponent_death"] = 53] = "king_opponent_death";
    ANIMATION_ID2[ANIMATION_ID2["king_opponent_move"] = 54] = "king_opponent_move";
    ANIMATION_ID2[ANIMATION_ID2["witch_opponent_idle"] = 55] = "witch_opponent_idle";
    ANIMATION_ID2[ANIMATION_ID2["witch_opponent_run"] = 56] = "witch_opponent_run";
    ANIMATION_ID2[ANIMATION_ID2["witch_opponent_attack"] = 57] = "witch_opponent_attack";
    ANIMATION_ID2[ANIMATION_ID2["witch_opponent_death"] = 58] = "witch_opponent_death";
    ANIMATION_ID2[ANIMATION_ID2["witch_opponent_death_from_special_attack"] = 59] = "witch_opponent_death_from_special_attack";
    ANIMATION_ID2[ANIMATION_ID2["witch_opponent_move"] = 60] = "witch_opponent_move";
    ANIMATION_ID2[ANIMATION_ID2["orc_opponent_idle"] = 61] = "orc_opponent_idle";
    ANIMATION_ID2[ANIMATION_ID2["orc_opponent_run"] = 62] = "orc_opponent_run";
    ANIMATION_ID2[ANIMATION_ID2["orc_opponent_attack"] = 63] = "orc_opponent_attack";
    ANIMATION_ID2[ANIMATION_ID2["orc_opponent_death"] = 64] = "orc_opponent_death";
    ANIMATION_ID2[ANIMATION_ID2["orc_opponent_move"] = 65] = "orc_opponent_move";
    ANIMATION_ID2[ANIMATION_ID2["dwarf_opponent_idle"] = 66] = "dwarf_opponent_idle";
    ANIMATION_ID2[ANIMATION_ID2["dwarf_opponent_run"] = 67] = "dwarf_opponent_run";
    ANIMATION_ID2[ANIMATION_ID2["dwarf_opponent_attack"] = 68] = "dwarf_opponent_attack";
    ANIMATION_ID2[ANIMATION_ID2["dwarf_opponent_death"] = 69] = "dwarf_opponent_death";
    ANIMATION_ID2[ANIMATION_ID2["dwarf_opponent_move"] = 70] = "dwarf_opponent_move";
    ANIMATION_ID2[ANIMATION_ID2["pike_man_idle"] = 71] = "pike_man_idle";
    ANIMATION_ID2[ANIMATION_ID2["pike_man_open_gate"] = 72] = "pike_man_open_gate";
    ANIMATION_ID2[ANIMATION_ID2["dragon_fly_right"] = 73] = "dragon_fly_right";
    ANIMATION_ID2[ANIMATION_ID2["dragon_fly_left"] = 74] = "dragon_fly_left";
    ANIMATION_ID2[ANIMATION_ID2["camera_left_to_right"] = 75] = "camera_left_to_right";
    ANIMATION_ID2[ANIMATION_ID2["camera_right_to_left"] = 76] = "camera_right_to_left";
    ANIMATION_ID2[ANIMATION_ID2["character_left_to_right_move"] = 77] = "character_left_to_right_move";
    ANIMATION_ID2[ANIMATION_ID2["hero_sword_slash"] = 78] = "hero_sword_slash";
    ANIMATION_ID2[ANIMATION_ID2["hero_transformation_pre_run"] = 79] = "hero_transformation_pre_run";
    ANIMATION_ID2[ANIMATION_ID2["hero_transformation_run"] = 80] = "hero_transformation_run";
    ANIMATION_ID2[ANIMATION_ID2["hero_transformation_hurt"] = 81] = "hero_transformation_hurt";
    ANIMATION_ID2[ANIMATION_ID2["hero_transformation_attack"] = 82] = "hero_transformation_attack";
    ANIMATION_ID2[ANIMATION_ID2["boss_idle"] = 83] = "boss_idle";
    ANIMATION_ID2[ANIMATION_ID2["boss_attack"] = 84] = "boss_attack";
    ANIMATION_ID2[ANIMATION_ID2["lightning"] = 85] = "lightning";
    ANIMATION_ID2[ANIMATION_ID2["mountain_pillar_activated"] = 86] = "mountain_pillar_activated";
  ...
  var ANIMATION_RUNNING_VALUES = {
    ...
    [61 /* orc_opponent_idle */]: 0,
    [62 /* orc_opponent_run */]: 0,
    [63 /* orc_opponent_attack */]: 0,
    [64 /* orc_opponent_death */]: 0,
    [65 /* orc_opponent_move */]: 0,
    [66 /* dwarf_opponent_idle */]: 0,
    [67 /* dwarf_opponent_run */]: 0,
    [68 /* dwarf_opponent_attack */]: 0,
    [69 /* dwarf_opponent_death */]: 0,
    [70 /* dwarf_opponent_move */]: 0,
    [73 /* dragon_fly_right */]: 0,
    [74 /* dragon_fly_left */]: 0,
    ...
    [49 /* pnj2_idle */]: 0,
    [50 /* king_opponent_idle */]: 0,
    [51 /* king_opponent_run */]: 0,
    [52 /* king_opponent_attack */]: 0,
    [53 /* king_opponent_death */]: 0,
    [54 /* king_opponent_move */]: 0,
    [55 /* witch_opponent_idle */]: 0,
    [56 /* witch_opponent_run */]: 0,
    [57 /* witch_opponent_attack */]: 0,
    [58 /* witch_opponent_death */]: 0,
    [60 /* witch_opponent_move */]: 0,
    [75 /* camera_left_to_right */]: 0,
    [76 /* camera_right_to_left */]: 0,
    [77 /* character_left_to_right_move */]: 0,
    [78 /* hero_sword_slash */]: 0,
    [79 /* hero_transformation_pre_run */]: 0,
    [80 /* hero_transformation_run */]: 0,
    [81 /* hero_transformation_hurt */]: 0,
    [82 /* hero_transformation_attack */]: 0,
    [72 /* pike_man_open_gate */]: 0,
    [71 /* pike_man_idle */]: 0,
    [83 /* boss_idle */]: 0,
    [84 /* boss_attack */]: 0,
    [85 /* lightning */]: 0,
    [86 /* mountain_pillar_activated */]: 0
  };
  ...
  var APP_ELEMENTS_ANIMATION_QUEUE = {
    hero: {
      ...
      associated_animations: [
        ...
        22 /* stop */,
        23 /* stop_time */,
        81 /* hero_transformation_hurt */,
        79 /* hero_transformation_pre_run */,
        80 /* hero_transformation_run */,
        82 /* hero_transformation_attack */
      ]
    },
    enemy: {
      request_queue: [],
    ...
    orc_enemy: {
      ...
      current_animation: null,
      associated_animations: [
        61 /* orc_opponent_idle */,
        62 /* orc_opponent_run */,
        63 /* orc_opponent_attack */,
        64 /* orc_opponent_death */
      ]
    },
    dwarf_enemy: {
      request_queue: [],
      current_animation: null,
      associated_animations: [
        66 /* dwarf_opponent_idle */,
        67 /* dwarf_opponent_run */,
        68 /* dwarf_opponent_attack */,
        69 /* dwarf_opponent_death */
      ]
    },
    golem_enemy: {
      request_queue: [],
    ...
    king_enemy: {
      ...
      current_animation: null,
      associated_animations: [
        50 /* king_opponent_idle */,
        51 /* king_opponent_run */,
        52 /* king_opponent_attack */,
        53 /* king_opponent_death */
      ]
    },
    witch_enemy: {
      request_queue: [],
      current_animation: null,
      associated_animations: [
        55 /* witch_opponent_idle */,
        57 /* witch_opponent_attack */,
        56 /* witch_opponent_run */,
        58 /* witch_opponent_death */,
        59 /* witch_opponent_death_from_special_attack */
      ]
    },
    learning_god: {
      request_queue: [],
  ...
  var createCharacterElement = (element) => {
    return element.name === 0 /* golem_master */ ? createMasterCharacterElementAndPrepareAnimations() : element.name === 2 /* pike_man */ ? createPikeCharacterAndPrepareAnimations() : createMountainGodCharacterAndPrepareAnimations();
  };
  ...
  var moveCamera = (direction, previousFrameTimestamp, mapSetIndex, cameraSpeed) => {
    const cameraAnimation = direction === 0 /* LEFT_TO_RIGHT */ ? 75 /* camera_left_to_right */ : 76 /* camera_right_to_left */;
  ...
  var initAllAnimations = () => {
    ...
    ANIMATION_RUNNING_VALUES[75 /* camera_left_to_right */] = 0;
    ANIMATION_RUNNING_VALUES[76 /* camera_right_to_left */] = 0;
    ANIMATION_RUNNING_VALUES[77 /* character_left_to_right_move */] = 0;
    ANIMATION_RUNNING_VALUES[79 /* hero_transformation_pre_run */] = 0;
    ANIMATION_RUNNING_VALUES[80 /* hero_transformation_run */] = 0;
    ANIMATION_RUNNING_VALUES[81 /* hero_transformation_hurt */] = 0;
    ANIMATION_RUNNING_VALUES[83 /* boss_idle */] = 0;
    ANIMATION_RUNNING_VALUES[84 /* boss_attack */] = 0;
  };
  ...
  var launchAttack = (special = false) => {
    ...
    clearTimeoutAndLaunchNewOne(
      ...
      setTimeout(() => {
        launchHeroRunAnimation();
      }, special ? 500 : transformed ? 240 : 350)
    );
  };
  ...
  var killEnemy = (enemy, fromSpecialAttack) => {
    const launchExplosion = () => {
      ...
      if (enemyCurrentlyOnScreen === 0 /* MOUNTAIN_GOD */) {
        ...
        launchAnimation(enemy.character, fromSpecialAttack ? 14 /* death_from_special_attack */ : 13 /* death */, false);
      }
    };
    launchExplosion();
      ...
      animationsStatesBlocks: [
        {
          ...
          animation: {
            id: 86 /* mountain_pillar_activated */,
            sprite: {
      ...
      animationsStatesBlocks: [
        {
          ...
          animation: {
            id: 79 /* hero_transformation_pre_run */,
            sprite: {
      ...
      animationsStatesBlocks: [
        {
          states: ALL_HERO_STATES,
          animation: {
            id: 82 /* hero_transformation_attack */,
            sprite: {
              path: ASSETS_PATH_BASE + "/characters/transformed_hero/attack/new",
              length: 12
            }
          }
        }
      ...
      animationsStatesBlocks: [
        {
          states: ALL_WITCH_ENEMY_STATES,
          animation: {
            id: 59 /* witch_opponent_death_from_special_attack */,
            sprite: {
              path: ASSETS_PATH_BASE + "/explosion",
              length: 12
            }
  ...
  var moveBackground = (direction) => {
    if (ANIMATION_RUNNING_VALUES[direction === 0 /* LEFT_TO_RIGHT */ ? 75 /* camera_left_to_right */ : 76 /* camera_right_to_left */] === 0) {
  ...
  var stopRun = (definitiveStop = false) => {
    ...
    interruptAnimation(75 /* camera_left_to_right */);
    interruptAnimation(76 /* camera_right_to_left */);
      ...
      setTimeout(() => {
        ...
        clearTimeoutAndLaunchNewOne(
          ...
          setTimeout(() => {
            ...
            setTimeout(turnHeroTransformationOff, 15e5);
          }, 5e3)
        );
      }, 500)
    );
  ...
  var launchSwordSlash = () => {
    ANIMATION_RUNNING_VALUES[78 /* hero_sword_slash */]++;
    if (ANIMATION_RUNNING_VALUES[78 /* hero_sword_slash */] !== 1 || transformed) {
      return;
    }
    ANIMATION_RUNNING_VALUES[78 /* hero_sword_slash */]++;
    ...
    setTimeout(() => {
      ...
      ANIMATION_RUNNING_VALUES[78 /* hero_sword_slash */] = 0;
    }, 75);
  };
  ...
  var launchHeroHurtAnimation = () => {
    launchAnimationAndDeclareItLaunched(
      ...
      1,
      false,
      transformed ? 81 /* hero_transformation_hurt */ : 6 /* hero_hurt */
    );
    if (!hardMode) {
      stopCameraMovingToRight();
    }
  ...
  var launchHeroTeleporationAnimation = () => {
    launchAnimation(heroCharacter, 21 /* teleportation */);
    setTimeout(
      () => {
        launchAnimation(heroCharacter, 15 /* idle */, false);
      },
  ...
  var launchHeroLightningSpeedAnimation = () => {
    ...
    ANIMATION_RUNNING_VALUES[85 /* lightning */] = 0;
    lightningImg.style.opacity = "0";
    setTimeout(() => {
      superSpeedOn = false;
      lightningImg.style.opacity = "1";
