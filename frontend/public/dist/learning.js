...
(See https://redux.js.org/faq/organizing-state#can-i-put-functions-promises-or-other-non-serializable-items-in-my-store-state)`);
  ...
  var learningGodContainer = document.getElementById("learning_god_container");
  var learningGodImg = document.getElementById("learningGodImg");
  var learningGodCharacter = new DefaultCharacter(learningGodImg, 0 /* idle */, learningGodAnimations);
  ...
  var openCourse = () => {
    launchAnimation(learningGodCharacter, 18 /* open_course */, false);
    setTimeout(
      () => {
  ...
  var launchGodFootsteps = () => {
    ...
    setTimeout(
      () => {
        const earthquakeAudio = document.getElementById("earthquake");
        earthquakeAudio.play();
        setTimeout(
          () => {
            launchMonsterAnimation();
            moveLearningGod(Date.now());
            const godStepsFast = document.getElementById("god_steps_fast");
  ...
  window.onload = () => {
    setTimeout(
      () => {
        launchAnimation(heroCharacter, 13 /* death */, false);
        setTimeout(
          () => {
  ...
  var launchMonsterAnimation = () => {
    launchAnimation(learningGodCharacter, 11 /* walk_left */);
  };
  document.addEventListener("keydown", (event) => {
    if (event.key === "l") {
  ...
  var moveLearningGod = (initialTS) => {
    ...
    if (learningGodLeft <= window.innerWidth * 0.7) {
      launchAnimation(learningGodCharacter, 15 /* idle */);
      const godStepsFast = document.getElementById("god_steps_fast");
      godStepsFast.pause();
      setTimeout(
        () => {
          const godSongAudio2 = document.getElementById("learning_god");
          godSongAudio2.play();
          setTimeout(
            () => {
