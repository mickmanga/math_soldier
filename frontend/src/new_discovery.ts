...
const extendedFormContainerButton = document.getElementById("extended_form_container_close_button")!; 
...
const createMapPalaceBlock = (left: number) => {
  ...
  if (left === window.innerWidth) {
    ...
    obeliskContainer.onclick = () =>
      (window.location.href = `http://localhost:3001/challenge?mode=hard&challengeId=675066592e63c665c9bc5a0d`);
...
let hiddenForm: HTMLElement | null;

const initExtendedFormButtonOnclick = () => {
...
let formsList = [
  ...
  {
    type: "challenge",
    challengeId: "675066592e63c665c9bc5a0d"
  }
]