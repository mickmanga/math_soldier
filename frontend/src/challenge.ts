...
const createCharacterElement = (element: CharacterElement) => {
   ...
   return element.name === CHARACTER_ELEMENTS_NAMES.golem_master ? createMasterCharacterElementAndPrepareAnimations() : element.name === CHARACTER_ELEMENTS_NAMES.pike_man ? createPikeCharacterAndPrepareAnimations() : createMountainGodCharacterAndPrepareAnimations();
}
...
const killEnemy = (enemy: EnemyInterface, fromSpecialAttack: boolean) => {
  const launchExplosion = () => {
    ...
    setTimeout(
     ...
     const explosionImg = document.getElementById("explosion_img") as HTMLImageElement;
    ...
    mountainGodHurt = true;
        ...
        launchAnimation(enemy.character, fromSpecialAttack ? AnimationType.death_from_special_attack : AnimationType.death, false);
    }
    ...
    setTimeout(() => {
      ...
      clearTimeoutAndLaunchNewOne(
        ...
        setTimeout(() => {
          ...
          setTimeout(turnHeroTransformationOff, 1500000);
        }, 5000)
      );
    }, 500)
  );
