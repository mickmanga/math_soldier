...
const Answer = require('./models/answer'); // New Answer model
...
},
{
  ...
  answers: {
    ...
    for (const section of sections) {
      ...
      // Save answers and collect their IDs
      for (const answer of [...section.answers.good, ...section.answers.bad]) {
        const newAnswer = new Answer({
          text: answer.text,
          explanation: answer.explanation,
          true: section.answers.good.includes(answer),
        });
